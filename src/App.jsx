    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <footer className="bg-white shadow-sm mt-12">
        <div className="container mx-auto px-4 py-6">
          ...
          <p className="text-right text-gray-600">Contact me<a href="mailto:0xkhush@gmail.com" className="text-gray-600 hover:text-blue-600 transition-colors">
          <Mail className="w-6 h-6" /></a></p>
        </div>
      </footer>
    </div>
  );
